    ...
    <div className="flex h-screen items-center justify-center bg-background px-4">
      <div className="relative w-full max-w-md bg-card border border-border rounded-lg p-8 shadow-lg">
        ...
        <button
          ...
          disabled={isLoading}
          className="login-google-btn w-full h-10 bg-blue-600 hover:bg-blue-700 border border-blue-700 rounded-lg text-white font-medium flex items-center justify-center gap-2 transition-all disabled:opacity-50"
        >
